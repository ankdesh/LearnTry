...
class SystemConfig:
    ...
    def __init__(self, image_name="ubuntu:22.04", disk_quota_gb=5, max_containers=50, host_base_path=os.path.abspath("./user_workspaces")):
        if not hasattr(self, '_initialized'):
            self.settings = {"image_name": image_name, "disk_quota_gb": disk_quota_gb, 
                             "max_containers": max_containers, "host_base_path": host_base_path}
